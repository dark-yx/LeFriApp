...
export default function Login() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error.message || "Error al crear la cuenta. Intenta nuevamente.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-500 to-blue-700 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-neutral-900 mb-2">LeFriAI</CardTitle>
        ...
        <CardContent className="p-6">
          ...
          <div className="mt-6">
            ...
            <Button 
              ...
              disabled={isLoading}
              className="w-full mt-4 bg-white border-2 border-neutral-200 rounded-xl py-3 px-4 flex items-center justify-center space-x-3 hover:border-blue-300 hover:shadow-md transition-all duration-200 text-neutral-700 hover:text-neutral-900"
              variant="outline"
            >
